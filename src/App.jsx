...
const App = () => {
  ...
  return (
    ...
    <div className="flex flex-col lg:flex-row bg-blue-900 text-white p-8 lg:gap-8">
      ...
      <div className="lg:w-1/2 flex flex-col justify-center lg:mr-8">
        ...
        <button className="bg-orange-500 w-10 h-10 flex items-center justify-center square-full">
